...
function keepPortraitOrientation() {
    ...
    if (window.innerWidth <= 768) {
        ...
        // Ha az eszköz fekvő módba kerül, akkor nem alkalmazunk semmilyen rotációt, csak biztosítjuk, hogy maradjon álló orientáció
        else if (window.innerWidth > window.innerHeight) {
            document.body.style.transform = "none"; // Ne forgassuk el
            document.body.style.width = "100vw";    // Maradjon az álló mód szélessége
            document.body.style.height = "100vh";   // Maradjon az álló mód magassága
...
window.addEventListener("resize", keepPortraitOrientation); 
